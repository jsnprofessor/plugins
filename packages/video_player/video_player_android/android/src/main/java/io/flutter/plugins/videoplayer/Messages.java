...
public class Messages {
  ...
  public static class CreateMessage {
    private @Nullable List<String> assets;
    public @Nullable List<String> getAssets() { return assets; }
    public void setAssets(@Nullable List<String> setterArg) {
      this.assets = setterArg;
    }
    ...
    public static final class Builder {
      private @Nullable List<String> assets;
      public @NonNull Builder setAssets(@Nullable List<String> setterArg) {
        this.assets = setterArg;
        return this;
      }
      private @Nullable List<String> uris;
    ...
    static @NonNull CreateMessage fromMap(@NonNull Map<String, Object> map) {
      ...
      pigeonResult.setAssets((List<String>)assets);
