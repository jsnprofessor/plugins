  ...
  group('VideoPlayerController', () {
    ...
    group('initialize', () {
      ...
      test('asset', () async {
        ...
        expect(fakeVideoPlayerPlatform.dataSources[0].assets?.first, 'a.avi');
      ...
      test('network', () async {
        ...
        expect(
          fakeVideoPlayerPlatform.dataSources[0].uris?.first,
          'https://127.0.0.1',
        );
        expect(
      ...
      test('init errors', () async {
        final VideoPlayerController controller = VideoPlayerController.network(
          <String>['http://testing.com/invalid_url'],
        );
      ...
      test('file', () async {
        final VideoPlayerController controller =
            VideoPlayerController.file(<File>[File('a.avi')]);
        await controller.initialize();

        expect(fakeVideoPlayerPlatform.dataSources[0].uris?.first, 'file://a.avi');
      });
    ...
    test('contentUri', () async {
      final VideoPlayerController controller =
          VideoPlayerController.contentUri(<Uri>[Uri.parse('content://video')]);
      await controller.initialize();

      expect(fakeVideoPlayerPlatform.dataSources[0].uris?.first, 'content://video');
    });
