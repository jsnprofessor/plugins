...
+ (instancetype)makeWithAssets:(nullable NSArray<NSString *> *)assets
    uris:(nullable NSArray<NSString *> *)uris
    packageName:(nullable NSString *)packageName
    formatHint:(nullable NSString *)formatHint
    httpHeaders:(NSDictionary<NSString *, NSString *> *)httpHeaders {
  FLTCreateMessage* pigeonResult = [[FLTCreateMessage alloc] init];
  pigeonResult.assets = assets;
  pigeonResult.uris = uris;
...
+ (FLTCreateMessage *)fromMap:(NSDictionary *)dict {
  FLTCreateMessage *pigeonResult = [[FLTCreateMessage alloc] init];
  pigeonResult.assets = GetNullableObject(dict, @"assets");
  pigeonResult.uris = GetNullableObject(dict, @"uris");
...
- (NSDictionary *)toMap {
  return [NSDictionary dictionaryWithObjectsAndKeys:(self.assets ? self.assets : [NSNull null]), @"assets", (self.uris ? self.uris : [NSNull null]), @"uris", (self.packageName ? self.packageName : [NSNull null]), @"packageName", (self.formatHint ? self.formatHint : [NSNull null]), @"formatHint", (self.httpHeaders ? self.httpHeaders : [NSNull null]), @"httpHeaders", nil];
}
@end
